...
import posterImg from "../../assets/contact.jpeg";
const ContactHero = () => {
  return (
    <section className="relative flex items-center justify-center w-full text-center h-[400px]">
      ...
      >
        <h1 className="text-5xl font-extrabold md:text-6xl">Contact Us</h1>
